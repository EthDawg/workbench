...
struct VoicePreferences: Codable, Equatable {
    ...
    // Optional decoding preserves preferences written before Readback sessions existed.
    var readbackShortcut: VoiceShortcut? = VoiceShortcut(keyCode: UInt32(kVK_ANSI_R))
    ...
    func shortcut(_ id: UInt32) -> VoiceShortcut {
        ...
        case 4: readbackShortcut ?? VoiceShortcut(keyCode: UInt32(kVK_ANSI_R))
