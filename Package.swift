...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "LocalVoice", dependencies: ["StageKit", "PhotoHandoffKit", .product(name: "FluidAudio", package: "FluidAudio")], resources: [.copy("Resources/build-readback-deck")], swiftSettings: intentSettings, linkerSettings: [.linkedFramework("Carbon")])
    ],
