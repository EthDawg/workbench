...
| One menu bar entry | Left/right click or configured shortcut; Window offers recovery | Seven fixed utility rows, inline shortcut editing, adjustments and a fixed receipt well | Closing leaves active work and the floating toolbar intact; Open Workbench, Settings and Shortcuts remain direct |
