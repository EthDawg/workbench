...
- `ReadbackModel` captures the display under the pointer, records linked narration into user-chosen folders and queues saved audio through the shared recognition engine. Its portable skill specifies faithful 16:9 slide generation without invented content.
