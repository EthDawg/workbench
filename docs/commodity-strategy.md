...
| Branded preparation | Existing assets/editable overlays, a complete background brief, and [last-mile tenant branding exports](research/tenant-branding-editor.md): fit/crop, position/padding, target-slot checks and clearly named files. | Prove repeat preparation and real destination rendering before integrated generation, discovery or brand inheritance. |
