...
The existing privacy responses were published with the account holder’s explicit approval. Live inspection confirmed four iPhone screenshots and one iPad screenshot already present. Build 3 is selected in the release draft, and the review contact is saved. The internal Maintainer testing group has this build and its invited account-holder tester; automatic distribution is off. Availability is configured for all 175 current countries or regions after release, following the account holder’s worldwide choice. After the account holder completed the declaration, Apple’s Business page showed Digital Services Act compliance **Active** for the 27 EU regions, with no outstanding regulatory requirements shown there. Content-rights confirmation remains a separate submission requirement. No private contact details belong in this public record. Physical dictation and paired scene-transfer acceptance still remain before App Review.
...
The recovered [build-specific App Review evidence guide](app-store/review-readiness.md) and incomplete mobile notes template retain the recording and acceptance handoff. They do not change the candidate status above or authorize submission.
