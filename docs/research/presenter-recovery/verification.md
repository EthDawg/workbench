...
- Checked authored Markdown/link targets and diff whitespace outside the reference patch. Patch context lines deliberately retain the leading space required by unified-diff syntax.
