...
- Local automated and native evidence is in [the repair acceptance record](verification/2026-09-22-menu-repair.md). Actual microphone + phone + meeting-receiver behavior, physical multi-display movement and VoiceOver remain separate acceptance checks.
